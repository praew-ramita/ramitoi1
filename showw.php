...
<div class="container">
  ...
  ?>
    <tr>
      ...
      <td><center><a href="formedit.php"><input type="submit" value="Edit" class="btn-info"></a>&nbsp;&nbsp;<a href="fromdelete.php"><input type="submit" value="Delete"  class="btn-default"></a></center></td>
    </tr>
  <?php
  }
  ?>
